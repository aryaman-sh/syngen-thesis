...
if __name__ == "__main__":
    ...
    image = nib.load("/scratch/itee/uqasha24/synthetic-generalisation/fatdata/images/sub-10010.FatImaging_W.nii.gz")
    image_data = image.get_fdata()
    seg = nib.load("/scratch/itee/uqasha24/synthetic-generalisation/clusteredimg/cluster_test.nii.gz")
    seg_data = seg.get_fdata()
    labels_list = np.unique(seg_data)
    #prior_data = sample_intensity_stats_from_image(image_data, seg_data, labels_list)
    #print(prior_data)
    build_intensity_stats("/scratch/itee/uqasha24/synthetic-generalisation/actualimg", "/scratch/itee/uqasha24/synthetic-generalisation/clusteredimg"
    , "./", labels_list)

    # so this gives me all the means and all the standard deviations